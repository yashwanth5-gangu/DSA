...
private:
    void build(int i, int l, int r, const std::vector<int>& baskets,
        ...
        segmentTree[i] =
            std::max(segmentTree[2 * i + 1], segmentTree[2 * i + 2]);
    }

    bool querySegmentTree(int i, int l, int r, std::vector<int>& segmentTree,
                          int val) {
